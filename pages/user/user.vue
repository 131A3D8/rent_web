<template>
  ...
  <div class="user-container">
    <button @click="fetchusers" :disabled="isLoading">{{ isLoading ? '正在查询...' : '查询' }}</button>
  ...
  methods: {
    async fetchusers() {
      ...
      try {
        ...
        console.error("Error fetching users:", error); // 调试信息：错误处理
...
.background-container {
  background-image: url('static/userbakegroud.png'); /* 替换为你的图片URL */
